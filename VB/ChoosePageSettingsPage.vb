    ...
    Public Class ChoosePageSettingsPageViewModel
        ...
        Public Sub New()
            ...
            AvailablePaperKinds = printerSettings.PaperSizes.Cast(Of PaperSize)().Select(Function(paperSize)
                Return New PaperKindViewInfo() With { _
                    .Id = CInt((paperSize.Kind)), _
                    .DisplayName = paperSize.PaperName, _
                    .SizeText = String.Format("{0}x{1}", paperSize.Width, paperSize.Height) _
                }
